...
public class Runigram {
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		for (int i = 0; i < newImage.length; i++) {
			for (int j = 0; j < newImage[1].length; j++) {
	...
	public static Color blend(Color c1, Color c2, double alpha) {
		int red,green,blue;
		red=(int)(c1.getRed()*alpha+(1-alpha)*c2.getRed());
		green=(int)(c1.getGreen()*alpha+(1-alpha)*c2.getGreen());
		blue=(int)(c1.getBlue()*alpha+(1-alpha)*c2.getBlue());
